...
class ChargesApi {
  ...
  Future<Response<ChargeOrderResponse>> ordersCreateCharge({ 
    ...
    final _path = r'/orders/{id}/charges'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
        "application/json"
    ];
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChargeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChargeResponse>> updateCharge({ 
    required String id,
    required ChargeUpdateRequest chargeUpdateRequest,
    String? acceptLanguage = 'es',
    String? xChildCompanyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/charges/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
        "application/json"
    ];
    ...
    try {
      const _type = FullType(ChargeUpdateRequest);
      _bodyData = _serializers.serialize(chargeUpdateRequest, specifiedType: _type);
    ...
    ChargeResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ChargeResponse),
      ) as ChargeResponse;
