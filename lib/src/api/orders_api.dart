...
class OrdersApi {
  ...
  Future<Response<OrderResponse>> orderCancelRefund({ 
    ...
    final _path = r'/orders/{id}/refunds/{refund_id}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'refund_id' '}', refundId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'User-Agent': r'Conekta/v2 DartBindings/6.0.0-beta.1',
  ...
  Future<Response<OrderResponse>> ordersCreateCapture({ 
    ...
    final _path = r'/orders/{id}/capture'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'User-Agent': r'Conekta/v2 DartBindings/6.0.0-beta.1',
