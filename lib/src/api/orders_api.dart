...
class OrdersApi {
  ...
  Future<Response<OrderResponse>> cancelOrder({ 
    ...
    final _path = r'/orders/{id}/cancel'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  ///
  /// Parameters:
  /// * [orderRequest] - requested field for order
  /// * [acceptLanguage] - Use for knowing which language to use
  /// * [xChildCompanyId] - In the case of a holding company, the company id of the child company to which will process the request.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  Future<Response<OrderResponse>> createOrder({ 
    ...
    try {
      const _type = FullType(OrderRequest);
      _bodyData = _serializers.serialize(orderRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [OrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderResponse>> getOrderById({ 
    required String id,
    String? acceptLanguage = 'es',
    String? xChildCompanyId,
    CancelToken? cancelToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetOrdersResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetOrdersResponse>> getOrders({ 
    String? acceptLanguage = 'es',
    String? xChildCompanyId,
    int? limit = 20,
    String? search,
    ...
    GetOrdersResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetOrdersResponse),
  ...
  /// Returns a [Future] containing a [Response] with a [OrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderResponse>> orderCancelRefund({ 
    required String id,
    ...
    final _path = r'/orders/{id}/refunds/{refund_id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'refund_id' '}', encodeQueryParameter(_serializers, refundId, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
    ];
    var localVarContentType = selectHeaderContentType(_contentTypes);
  ...
  /// Parameters:
  /// * [id] - Identifier of the resource
  /// * [orderRefundRequest] - requested field for a refund
  /// * [acceptLanguage] - Use for knowing which language to use
  /// * [xChildCompanyId] - In the case of a holding company, the company id of the child company to which will process the request.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future] containing a [Response] with a [OrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderResponse>> orderRefund({ 
    required String id,
    required OrderRefundRequest orderRefundRequest,
    String? acceptLanguage = 'es',
    String? xChildCompanyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/orders/{id}/refunds'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
        "application/json"
    ];
    ...
    try {
      const _type = FullType(OrderRefundRequest);
      _bodyData = _serializers.serialize(orderRefundRequest, specifiedType: _type);
  ...
  /// * [acceptLanguage] - Use for knowing which language to use
  /// * [xChildCompanyId] - In the case of a holding company, the company id of the child company to which will process the request.
  /// * [orderCaptureRequest] - requested fields for capture order
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [OrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderResponse>> ordersCreateCapture({ 
    required String id,
    String? acceptLanguage = 'es',
    String? xChildCompanyId,
    ...
    final _path = r'/orders/{id}/capture'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
        "application/json"
    ];
    ...
    try {
      const _type = FullType(OrderCaptureRequest);
      _bodyData = orderCaptureRequest == null ? null : _serializers.serialize(orderCaptureRequest, specifiedType: _type);
