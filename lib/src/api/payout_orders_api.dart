...
class PayoutOrdersApi {
  ...
  const PayoutOrdersApi(this._dio, this._serializers);
  ...
  Future<Response<PayoutOrderResponse>> cancelPayoutOrderById({ 
    required String id,
    ...
    final _path = r'/payout_orders/{id}/cancel'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    PayoutOrderResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PayoutOrderResponse),
    ...
    return Response<PayoutOrderResponse>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [PayoutOrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PayoutOrderResponse>> getPayoutOrderById({ 
    required String id,
    String? acceptLanguage = 'es',
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/payout_orders/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
    ];
    var localVarContentType = selectHeaderContentType(_contentTypes);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PayoutOrdersResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PayoutOrdersResponse>> getPayoutOrders({ 
    String? acceptLanguage = 'es',
    int? limit = 20,
    String? search,
    String? next,
    ...
    PayoutOrdersResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PayoutOrdersResponse),
      ) as PayoutOrdersResponse;
    ...
    return Response<PayoutOrdersResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
