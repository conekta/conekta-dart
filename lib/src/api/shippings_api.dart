...
class ShippingsApi {
  ...
  /// * [shippingRequest] - requested field for a shipping
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ShippingOrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ShippingOrderResponse>> ordersCreateShipping({ 
    required String id,
    required ShippingRequest shippingRequest,
    ...
    final _path = r'/orders/{id}/shipping_lines'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(ShippingRequest);
      _bodyData = _serializers.serialize(shippingRequest, specifiedType: _type);
    ...
    ShippingOrderResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ShippingOrderResponse),
      ) as ShippingOrderResponse;
  ...
  /// Returns a [Future] containing a [Response] with a [ShippingOrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ShippingOrderResponse>> ordersDeleteShipping({ 
    required String id,
    ...
    final _path = r'/orders/{id}/shipping_lines/{shipping_id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'shipping_id' '}', encodeQueryParameter(_serializers, shippingId, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
    ];
    var localVarContentType = selectHeaderContentType(_contentTypes);
  ...
  /// Returns a [Future] containing a [Response] with a [ShippingOrderResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ShippingOrderResponse>> ordersUpdateShipping({ 
    required String id,
    required String shippingId,
    required ShippingRequest shippingRequest,
    String? acceptLanguage = 'es',
