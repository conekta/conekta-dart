...
class ShippingsApi {
  ...
  Future<Response<ShippingOrderResponse>> ordersCreateShipping({ 
    ...
    final _path = r'/orders/{id}/shipping_lines'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<ShippingOrderResponse>> ordersDeleteShipping({ 
    ...
    final _path = r'/orders/{id}/shipping_lines/{shipping_id}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'shipping_id' '}', shippingId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'User-Agent': r'Conekta/v2 DartBindings/6.0.0-beta.1',
