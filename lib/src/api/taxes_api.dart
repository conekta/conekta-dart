...
class TaxesApi {
  ...
  Future<Response<UpdateOrderTaxResponse>> ordersCreateTaxes({ 
    ...
    final _path = r'/orders/{id}/tax_lines'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  Future<Response<UpdateOrderTaxResponse>> ordersDeleteTaxes({ 
    ...
    final _path = r'/orders/{id}/tax_lines/{tax_id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'tax_id' '}', encodeQueryParameter(_serializers, taxId, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
    ];
    var localVarContentType = selectHeaderContentType(_contentTypes);
