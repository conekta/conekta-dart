...
class PaymentMethodsApi {
  ...
  /// * [createCustomerPaymentMethodsRequest] - requested field for customer payment methods
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateCustomerPaymentMethodsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCustomerPaymentMethodsResponse>> createCustomerPaymentMethods({ 
    required String id,
    required CreateCustomerPaymentMethodsRequest createCustomerPaymentMethodsRequest,
    ...
    final _path = r'/customers/{id}/payment_sources'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CreateCustomerPaymentMethodsRequest);
      _bodyData = _serializers.serialize(createCustomerPaymentMethodsRequest, specifiedType: _type);
    ...
    CreateCustomerPaymentMethodsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateCustomerPaymentMethodsResponse),
      ) as CreateCustomerPaymentMethodsResponse;
    ...
    return Response<CreateCustomerPaymentMethodsResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerPaymentMethodsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerPaymentMethodsResponse>> deleteCustomerPaymentMethods({ 
    required String id,
    ...
    final _path = r'/customers/{id}/payment_sources/{payment_method_id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'payment_method_id' '}', encodeQueryParameter(_serializers, paymentMethodId, const FullType(String)).toString());
    // to determine the Accept header
    List<String> _contentTypes = [ 
    ];
    var localVarContentType = selectHeaderContentType(_contentTypes);
    ...
    UpdateCustomerPaymentMethodsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UpdateCustomerPaymentMethodsResponse),
      ) as UpdateCustomerPaymentMethodsResponse;
    ...
    return Response<UpdateCustomerPaymentMethodsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetPaymentMethodResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPaymentMethodResponse>> getCustomerPaymentMethods({ 
    required String id,
    String? acceptLanguage = 'es',
    String? xChildCompanyId,
    int? limit = 20,
    ...
    GetPaymentMethodResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetPaymentMethodResponse),
    ...
    return Response<GetPaymentMethodResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
