...
class PaymentMethodsApi {
  ...
  Future<Response<CreateCustomerPaymentMethodsResponse>> createCustomerPaymentMethods({ 
    ...
    final _path = r'/customers/{id}/payment_sources'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<UpdateCustomerPaymentMethodsResponse>> deleteCustomerPaymentMethods({ 
    ...
    final _path = r'/customers/{id}/payment_sources/{payment_method_id}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'payment_method_id' '}', paymentMethodId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'User-Agent': r'Conekta/v2 DartBindings/6.0.0-beta.1',
