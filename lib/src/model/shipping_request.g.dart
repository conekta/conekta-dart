...
class _$ShippingRequest extends ShippingRequest {
  ...
  factory _$ShippingRequest([void Function(ShippingRequestBuilder)? updates]) =>
  ...
  _$ShippingRequest._(
      ...
      this.metadata})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(amount, r'ShippingRequest', 'amount');
  }
...
class ShippingRequestBuilder
    implements Builder<ShippingRequest, ShippingRequestBuilder> {
