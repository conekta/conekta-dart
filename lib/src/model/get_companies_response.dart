...
/// * [data] 
@BuiltValue()
abstract class GetCompaniesResponse implements Built<GetCompaniesResponse, GetCompaniesResponseBuilder> {
  ...
  static void _defaults(GetCompaniesResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetCompaniesResponse> get serializer => _$GetCompaniesResponseSerializer();
}

class _$GetCompaniesResponseSerializer implements PrimitiveSerializer<GetCompaniesResponse> {
  @override
  final Iterable<Type> types = const [GetCompaniesResponse, _$GetCompaniesResponse];

  @override
  final String wireName = r'GetCompaniesResponse';
  ...
  void _deserializeProperties(
    ...
    required GetCompaniesResponseBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(CompanyResponse)]),
  ...
  @override
  GetCompaniesResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetCompaniesResponseBuilder();
