...
part 'token_request_card.g.dart';
...
@BuiltValue()
abstract class TokenRequestCard implements Built<TokenRequestCard, TokenRequestCardBuilder> {
  ...
  factory TokenRequestCard([void updates(TokenRequestCardBuilder b)]) = _$TokenRequestCard;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TokenRequestCardBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TokenRequestCard> get serializer => _$TokenRequestCardSerializer();
}

class _$TokenRequestCardSerializer implements PrimitiveSerializer<TokenRequestCard> {
  @override
  final Iterable<Type> types = const [TokenRequestCard, _$TokenRequestCard];

  @override
  final String wireName = r'TokenRequestCard';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TokenRequestCard object, {
  ...
  void _deserializeProperties(
    ...
    required TokenRequestCardBuilder result,
  ...
  @override
  TokenRequestCard deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TokenRequestCardBuilder();
