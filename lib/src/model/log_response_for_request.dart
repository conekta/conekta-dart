...
part 'log_response_for_request.g.dart';
...
/// * [version] 
@BuiltValue()
abstract class LogResponseForRequest implements Built<LogResponseForRequest, LogResponseForRequestBuilder> {
  ...
  LogResponseForRequest._();

  factory LogResponseForRequest([void updates(LogResponseForRequestBuilder b)]) = _$LogResponseForRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LogResponseForRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LogResponseForRequest> get serializer => _$LogResponseForRequestSerializer();
}

class _$LogResponseForRequestSerializer implements PrimitiveSerializer<LogResponseForRequest> {
  @override
  final Iterable<Type> types = const [LogResponseForRequest, _$LogResponseForRequest];

  @override
  final String wireName = r'LogResponseForRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LogResponseForRequest object, {
  ...
  void _deserializeProperties(
    ...
    required LogResponseForRequestBuilder result,
  ...
  @override
  LogResponseForRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LogResponseForRequestBuilder();
