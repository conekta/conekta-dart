...
class _$ProductOrderResponseSerializer implements PrimitiveSerializer<ProductOrderResponse> {
  @override
  final Iterable<Type> types = const [ProductOrderResponse, _$ProductOrderResponse];

  @override
  final String wireName = r'ProductOrderResponse';
  ...
  void _deserializeProperties(
    ...
    required ProductOrderResponseBuilder result,
  ...
  @override
  ProductOrderResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProductOrderResponseBuilder();
