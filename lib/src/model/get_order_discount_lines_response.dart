...
part 'get_order_discount_lines_response.g.dart';
...
abstract class GetOrderDiscountLinesResponse implements GetOrderDiscountLinesResponseAllOf, Page, Pagination, Built<GetOrderDiscountLinesResponse, GetOrderDiscountLinesResponseBuilder> {
  ...
  static void _defaults(GetOrderDiscountLinesResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetOrderDiscountLinesResponse> get serializer => _$GetOrderDiscountLinesResponseSerializer();
}

class _$GetOrderDiscountLinesResponseSerializer implements PrimitiveSerializer<GetOrderDiscountLinesResponse> {
  @override
  final Iterable<Type> types = const [GetOrderDiscountLinesResponse, _$GetOrderDiscountLinesResponse];

  @override
  final String wireName = r'GetOrderDiscountLinesResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetOrderDiscountLinesResponse object, {
  ...
  void _deserializeProperties(
    ...
    required GetOrderDiscountLinesResponseBuilder result,
  ...
  @override
  GetOrderDiscountLinesResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetOrderDiscountLinesResponseBuilder();
