...
@BuiltValue()
abstract class CustomersResponse implements Built<CustomersResponse, CustomersResponseBuilder> {
  ...
  static void _defaults(CustomersResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CustomersResponse> get serializer => _$CustomersResponseSerializer();
}

class _$CustomersResponseSerializer implements PrimitiveSerializer<CustomersResponse> {
  @override
  final Iterable<Type> types = const [CustomersResponse, _$CustomersResponse];

  @override
  final String wireName = r'CustomersResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CustomersResponse object, {
  ...
  void _deserializeProperties(
    ...
    required CustomersResponseBuilder result,
      ...
      switch (key) {
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(CustomerResponse)]),
  ...
  @override
  CustomersResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CustomersResponseBuilder();
