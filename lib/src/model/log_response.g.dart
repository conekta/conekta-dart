...
class _$LogResponse extends LogResponse {
  ...
  factory _$LogResponse([void Function(LogResponseBuilder)? updates]) =>
      (new LogResponseBuilder()..update(updates))._build();
  ...
  _$LogResponse._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        createdAt, r'LogResponse', 'createdAt');
    BuiltValueNullFieldError.checkNotNull(id, r'LogResponse', 'id');
    BuiltValueNullFieldError.checkNotNull(livemode, r'LogResponse', 'livemode');
  }
  ...
  @override
  LogResponseBuilder toBuilder() => new LogResponseBuilder()..replace(this);
      ...
      _$result = _$v ??
          new _$LogResponse._(
              ...
              livemode: BuiltValueNullFieldError.checkNotNull(
                  livemode, r'LogResponse', 'livemode'),
