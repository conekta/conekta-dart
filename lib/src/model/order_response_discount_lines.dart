...
/// * [data] 
@BuiltValue()
abstract class OrderResponseDiscountLines implements Built<OrderResponseDiscountLines, OrderResponseDiscountLinesBuilder> {
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(DiscountLinesDataResponse)]),
