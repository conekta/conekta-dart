...
part 'logs_response_data.g.dart';
...
/// * [version] 
@BuiltValue()
abstract class LogsResponseData implements Built<LogsResponseData, LogsResponseDataBuilder> {
  ...
  factory LogsResponseData([void updates(LogsResponseDataBuilder b)]) = _$LogsResponseData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LogsResponseDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LogsResponseData> get serializer => _$LogsResponseDataSerializer();
}

class _$LogsResponseDataSerializer implements PrimitiveSerializer<LogsResponseData> {
  @override
  final Iterable<Type> types = const [LogsResponseData, _$LogsResponseData];

  @override
  final String wireName = r'LogsResponseData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LogsResponseData object, {
  ...
  void _deserializeProperties(
    ...
    required LogsResponseDataBuilder result,
  ...
  @override
  LogsResponseData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LogsResponseDataBuilder();
