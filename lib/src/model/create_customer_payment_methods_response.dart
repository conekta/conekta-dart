...
part 'create_customer_payment_methods_response.g.dart';
...
/// * [paymentSourceStatus] 
@BuiltValue()
abstract class CreateCustomerPaymentMethodsResponse implements Built<CreateCustomerPaymentMethodsResponse, CreateCustomerPaymentMethodsResponseBuilder> {
  ...
  CreateCustomerPaymentMethodsResponse._();

  factory CreateCustomerPaymentMethodsResponse([void updates(CreateCustomerPaymentMethodsResponseBuilder b)]) = _$CreateCustomerPaymentMethodsResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateCustomerPaymentMethodsResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateCustomerPaymentMethodsResponse> get serializer => _$CreateCustomerPaymentMethodsResponseSerializer();
}

extension CreateCustomerPaymentMethodsResponseDiscriminatorExt on CreateCustomerPaymentMethodsResponse {
...
extension CreateCustomerPaymentMethodsResponseBuilderDiscriminatorExt on CreateCustomerPaymentMethodsResponseBuilder {
    String? get discriminatorValue {
...
class _$CreateCustomerPaymentMethodsResponseSerializer implements PrimitiveSerializer<CreateCustomerPaymentMethodsResponse> {
  @override
  final Iterable<Type> types = const [CreateCustomerPaymentMethodsResponse, _$CreateCustomerPaymentMethodsResponse];

  @override
  final String wireName = r'CreateCustomerPaymentMethodsResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateCustomerPaymentMethodsResponse object, {
  ...
  @override
  CreateCustomerPaymentMethodsResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateCustomerPaymentMethodsResponseBuilder();
    Object? oneOfDataSrc;
