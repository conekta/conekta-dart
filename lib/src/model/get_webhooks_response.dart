...
/// * [data] 
@BuiltValue()
abstract class GetWebhooksResponse implements Built<GetWebhooksResponse, GetWebhooksResponseBuilder> {
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(WebhookResponse)]),
