...
class CheckoutsResponseBuilder
    implements Builder<CheckoutsResponse, CheckoutsResponseBuilder> {
  ...
  set data(ListBuilder<CheckoutResponse>? data) => _$this._data = data;
  ...
  @override
  void replace(CheckoutsResponse other) {
