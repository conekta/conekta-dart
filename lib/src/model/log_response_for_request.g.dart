...
part of 'log_response_for_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LogResponseForRequest extends LogResponseForRequest {
  @override
  final int createdAt;
  @override
  final String id;
  ...
  factory _$LogResponseForRequest(
          [void Function(LogResponseForRequestBuilder)? updates]) =>
      (new LogResponseForRequestBuilder()..update(updates))._build();

  _$LogResponseForRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        createdAt, r'LogResponseForRequest', 'createdAt');
    BuiltValueNullFieldError.checkNotNull(id, r'LogResponseForRequest', 'id');
    BuiltValueNullFieldError.checkNotNull(
        livemode, r'LogResponseForRequest', 'livemode');
  }

  @override
  LogResponseForRequest rebuild(
          void Function(LogResponseForRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LogResponseForRequestBuilder toBuilder() =>
      new LogResponseForRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LogResponseForRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LogResponseForRequest')
...
class LogResponseForRequestBuilder
    implements Builder<LogResponseForRequest, LogResponseForRequestBuilder> {
  _$LogResponseForRequest? _$v;
  ...
  LogResponseForRequestBuilder() {
    LogResponseForRequest._defaults(this);
  }

  LogResponseForRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(LogResponseForRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$LogResponseForRequest;
  }

  @override
  void update(void Function(LogResponseForRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LogResponseForRequest build() => _build();

  _$LogResponseForRequest _build() {
    _$LogResponseForRequest _$result;
    try {
      _$result = _$v ??
          new _$LogResponseForRequest._(
              createdAt: BuiltValueNullFieldError.checkNotNull(
                  createdAt, r'LogResponseForRequest', 'createdAt'),
              id: BuiltValueNullFieldError.checkNotNull(
                  id, r'LogResponseForRequest', 'id'),
              ipAddress: ipAddress,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'LogResponseForRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
