...
/// * [data] - Transactions
@BuiltValue()
abstract class GetTransactionsResponse implements Built<GetTransactionsResponse, GetTransactionsResponseBuilder> {
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(TransactionResponse)]),
